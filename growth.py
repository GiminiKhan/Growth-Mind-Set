...
upload_files = st.file_uploader("Upload your files(acceptsCSV or Excel):", type=["cvs","xlsx"], accept_multiple_files=(True))
...
#data cleaning option
           st.subheader("Data Cleaing Option")
           if st.checkbox(f"clean data for {file.name}"):
            call, col2 = st.columns(2)
